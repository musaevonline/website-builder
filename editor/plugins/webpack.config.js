...
const templates = globby.sync(["*/template.html"], { ignore: ["node_modules/**", "dist*/**"] })
const singleScripts = globby.sync(["*/script.js"], { ignore: ["node_modules/**", "dist*/**"] })
const groupScripts = globby.sync(["*/js/*.js"], { ignore: ["node_modules/**", "dist*/**"] })
